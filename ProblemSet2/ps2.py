...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    """
    timeStepsTaken = 0
    minNumTiles = width * height * min_coverage
    for run in range(num_trials):
        ...
        while room.getNumCleanedTiles() < minNumTiles:
            timeStepsTaken += 1
    ...
    return float(timeStepsTaken) / float(num_trials)

# Uncomment this line to see how much your simulation takes on average
#print  runSimulation(1, 1.0, 5, 5, 0.75, 30, StandardRobot) # 150
#print  runSimulation(1, 1.0, 10, 10, 0.75, 30, StandardRobot) # 190
#print  runSimulation(1, 1.0, 10, 10, 0.90, 30, StandardRobot) # 310
#print  runSimulation(1, 1.0, 20, 20, 1.0, 30, StandardRobot) # 3322
#print  runSimulation(3, 1.0, 20, 20, 1.0, 30, StandardRobot) # 1105
